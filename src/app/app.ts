...
app.get('/intblfml/v1/plugins/intblfml/documents/2964/question/372303/intable-formulas', (request, response) => {
  response.send(formulas);
});

app.get('/intblfml/v1/plugins/intblfml/documents/2964/question/372242/intable-formulas', (request, response) => {
